layui.use(['form', 'util', 'layer', 'laydate', 'table', 'laytpl', 'util','excel','jquery'], function() {
    ...
    layer = parent.layer === undefined ? layui.layer : top.layer,
        ...
        elem: '#newsList',
        url: 'http://apply.imbatv.cn//tool/applicant?tid=3&state=10',
        limit: 15,
        limits: [15, 30, 45, 60],
        page: true,
        //,…… //其他参数
        cols: [
            [
                ...
                {field: 'extra_filed1', title: '段位截图', width:180, align:"center",templet:function(d){
    ...
    function exportApiDemo() {
        $.ajax({
            url: "http://apply.imbatv.cn//tool/applicant?tid=3&state=10&limit=2000",
            type: "GET",
            dataType: 'json',
            success(res) {
                console.log(res);
